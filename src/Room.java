...
public class Room {
    ...
    private static ImageIcon roomImage = new ImageIcon(Room.class.getResource("/Assets/Images/roombg.png"));
    ...
    private static ArrayList<Entities> entities = new ArrayList<>();
    ...
    public Room() {
        ...
        try {
            ...
            for (PetStoreDB.FurnitureRecord rec : owned) {
                try {
                    ImageIcon img = new ImageIcon(Room.class.getResource("/Assets/Images/Furniture/" + rec.filepath));
