...
public class PetStore extends JScrollPane implements ActionListener{
    ...
    private ArrayList<JLabel> priceLabels = new ArrayList<>();
    ...
    public PetStore(Menu m, Room room) {
        ...
        try {
            fdb = new PetStoreDB();
            InputStream catalogStream = PetStore.class.getResourceAsStream("/Assets/Images/Furniture/Catalog.txt");
            fdb.ensureCatalogFromFile(catalogStream);
        ...
        for (int i=0; i<items.size(); i++) {
            ...
            ImageIcon img = new ImageIcon(PetStore.class.getResource("/Assets/Images/Furniture/" + rec.filepath));
            images.add(img);
