        ...
        for (int day = 1; day <= daysInMonth; day++) {
            ...
            try {
                if (db != null && db.isCheckedIn(cellDate)) {
                    calendarCell.setImage(new ImageIcon(new ImageIcon(HabitCalender.class.getResource("/Assets/Images/paw_stamp.png")).getImage().getScaledInstance(width, width, Image.SCALE_SMOOTH)));
                } else {
